...
def main():
	...
	ap.add_argument("-i","--image",required= False ,help="Enter the training image.")	#add_argument method to take the input from commandline and apply all the constraints to it.
